...
if __name__ == "__main__":
    print "TripEvent.objects.all().delete(): ", TripEvent.objects.all().delete()
    ...
    record_trip_event(4, 12, 1386673499, Decimal("37.5688"),   Decimal("-122.316336"), Decimal("12.0"), Decimal("8.0"), 5) #future #San Mateo
    print "TripEvent.objects.all(): ", TripEvent.objects.all()
